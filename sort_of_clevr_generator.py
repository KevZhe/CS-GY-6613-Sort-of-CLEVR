...
for _ in range(train_size):
    ...
    train_state_desc.append(dataset_state_desc)
...
filename_pixel = os.path.join(dirs,'sort-of-clevr.pickle')
filename_state_desc = os.path.join(dirs,'sort-of-clevr_state_desc.pickle')

with open(filename_pixel, 'wb') as f:
    pickle.dump((train_datasets, test_datasets), f)

print('pixel datasets saved at {}'.format(filename_pixel))

with open(filename_state_desc, 'wb') as fs:
    pickle.dump((train_state_desc, test_state_desc), fs)

print('state description datasets saved at {}'.format(filename_state_desc))
